...
instr mySendOsc
	...
	if (strcmp(Stype,"sf")==0) then ; notification
		Smessage strget p7
		idur = p8
		OSCsend 1, Shost, $OSCPORT,Sdestination, Stype, Smessage, idur
	elseif (strcmp(Stype,"f")==0) then ; tempo
		itempo = p7
		OSCsend 1, Shost, $OSCPORT,Sdestination, Stype, itempo
	else ; beatbar and led send two bumbers
		ip1 = p7
		ip2 = p8
		OSCsend 1, Shost, $OSCPORT,Sdestination, Stype, ip1, ip2
	endif
